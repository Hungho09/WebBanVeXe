        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Bus>().HasData(
                new Bus { 
                    ...
                    BusTypeId = Guid.Parse("33333333-3333-3333-3333-333333333333"), // Giường nằm
                    SeatCount = 44,
                    Status = Domain.Enums.BusStatus.Available
                },
                new Bus { 
                    Id = Guid.Parse("66666666-6666-6666-6666-666666666666"), 
                    PlateNumber = "51B-678.90", 
                    CompanyName = "Thành Bưởi", 
                    BusTypeId = Guid.Parse("22222222-2222-2222-2222-222222222222"), // Limousine
                    SeatCount = 9,
                    Status = Domain.Enums.BusStatus.Active
                }
            );
